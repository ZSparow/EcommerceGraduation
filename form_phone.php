  ...
  <body>
    <div class="form-container">
      ...
      <div class="form-content">
        ...
        <input type="text" name=" screen" placeholder="screen" required/>
        ...
        <textarea name=" description" placeholder="description" required cols="30" rows="3"></textarea>
        

        <button type="submit" class="submit" name="insert_ph">insert</button> 
        </div>       
      </form>
