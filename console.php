...
<head>
    ...
    <title>Consoles | Tech shop</title>
...
<section class='slider'>
        <div class="items-view">
          <div class="text-box">
            <h1>nintendo swithch</h1>
            <p>Enjoy your time with the new nintendo swithch</p>
          ...
          <div class="image-box">
          <img src="images/items/consoles/nintendo-switch.png" width= 200px class='ad-image'>
        ...
        <div class="items-view">
          <div class="text-box">
            <h1>Playstation 5</h1>
            <p>By the new PS5 and lunch you gaming abilities</p>
              <div class="buttons-container">
          ...
          <div class="image-box">
          <img src="images/items/consoles/ps5.png" width= 200px class='ad-image'>
          </div><!-- end of image-box -->
        </div><!-- end of items-view -->
        ...
        <div class="items-view">
          <div class="text-box">
            <h1>Xbox Series X</h1>
            <p>The new Xbox Series X fastest, most powerful gaming console in 2020</p>
              <div class="buttons-container">
          ...
          <div class="image-box">
          <img src="images/items/consoles/xbox-series-x.png" width= 200px class='ad-image'>
          </div><!-- end of image-box -->
        </div><!-- end of items-view -->
...
<div class="card">
  <div class="front">
    <div class="image-box">
      ...
      <img src="files/consoles/<?php echo $row['img'];?>" alt="item image" class='item-image'>
