...
<head>
    ...
    <title>Computers | Tech shop</title>
  ...
  <header class='header'>
      ...
      <section class="slider">
        <div class="items-view">
          ...
          <div class="text-box">
            <h1>ROG Zephyrus Duo</h1>
            <p>Meet the new ROG Zephyrus Duo with two screens to help you with video and photo edition. and also lunch your abilities with gaming.</p>
              <div class="buttons-container">
                <!-- <a href="#" class="btn btn1">View Details</a> -->
                <a href="#" class="btn btn2 buy-btn">Buy now</a>
              </div>
          </div> <!-- end of text-box -->
          <div class="image-box">
            <img src="images/items/computers/ROGZephyrusDuo.png" width= 200px class='ad-image'>
        ...
        <div class="items-view">
          ...
          <div class="text-box">
            <h1>ASUS Zenbook Dou</h1>
            <p>With two screens to help you with your work, fly with your abilities in video edition and gaming with high performance.</p>
              <div class="buttons-container">
                <!-- <a href="#" class="btn btn1">View Details</a> -->
                <a href="#" class="btn btn2 buy-btn">Buy now</a>
              </div>
          ...
          <div class="image-box">
            <img src="images/items/computers/asuszenbookdou.png" width= 200px class='ad-image'>
          </div><!-- end of image-box -->
        </div><!-- end of items-view -->
        <div class="items-view">

          <div class="text-box">
            <h1>Lenovo Yoga 720</h1>
            <p>The new flexible Yoga 720 From lenovo. With touch Screen, it can be laptop or tablet. you can be confortable using it.</p>
              <div class="buttons-container">
                <!-- <a href="#" class="btn btn1">View Details</a> -->
                <a href="#" class="btn btn2 buy-btn">Buy now</a>
              </div>
          ...
          <div class="image-box">
            <img src="images/items/computers/LenovoYoga720.png" width= 200px class='ad-image'>
          </div><!-- end of image-box -->
        </div><!-- end of items-view -->
      </section>
  </header>
...
<div class="card">
  <div class="front">
    <div class="image-box">
    <img src="files/computers/<?php echo $row['img'];?>" alt="item image" class='item-image'>
    <img src="images/brands/<?php echo $row['brand'];?>.png" alt="brand icon" class="brand-image">
    ...
    <div class="item-description">
      <ul>
        ...
        <li>graphics card:- <?php echo $row['graphics'];?></li>
      </ul>
    </div>
